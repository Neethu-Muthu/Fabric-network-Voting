...
export voters_PEER_TLSROOTCERT=${PWD}/organizations/peerOrganizations/voters.example.com/peers/peer0.voters.example.com/tls/ca.crt
export commissioner_PEER_TLSROOTCERT=${PWD}/organizations/peerOrganizations/commissioner.example.com/peers/peer0.commissioner.example.com/tls/ca.crt
export auditor_PEER_TLSROOTCERT=${PWD}/organizations/peerOrganizations/auditor.example.com/peers/peer0.auditor.example.com/tls/ca.crt


export CORE_PEER_TLS_ENABLED=true
export CORE_PEER_LOCALMSPID=votersMSP
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/voters.example.com/peers/peer0.voters.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/voters.example.com/users/Admin@voters.example.com/msp
...
jq '.channel_group.groups.Application.groups.votersMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.org1.example.com","port": 7051}]},"version": "0"}}' config_copy.json > modified_config.json
...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/commissioner.example.com/peers/peer0.commissioner.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/commissioner.example.com/users/Admin@commissioner.example.com/msp
...
jq '.channel_group.groups.Application.groups.commissionerMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.commissioner.example.com","port": 9051}]},"version": "0"}}' config_copy.json > modified_config.json
...
# echo "—---------------Commit chaincode in commissioner peer—-------------"
...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/auditor.example.com/peers/peer0.auditor.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/auditor.example.com/users/Admin@auditor.example.com/msp
...
jq '.channel_group.groups.Application.groups.auditorMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.auditor.example.com","port": 9051}]},"version": "0"}}' config_copy.json > modified_config.json
...
peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --channelID $CHANNEL_NAME --name basic --version 1.0 --sequence 1 --tls --cafile $ORDERER_CA --peerAddresses localhost:7051 --tlsRootCertFiles $voters_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $commissioner_PEER_TLSROOTCERT
sleep 1
